...
<div class="row" id="userform">
  <div class="header center"><h3>ADD DEPARTMENT</h3></div>
  <center><p><span id="dsr"></span></p></center>
...
<div class="row" id="userform">
  ...
  <div class="input-field col s6">
    <center><a class="waves-effect waves-light btn" id="addDept" onclick="hi()">ADD DEPAERTMENT</a>&nbsp;&nbsp;<a class="waves-effect waves-light btn" id="canDept">CANCEL</a></center>
  </div>
</div>
...
<script type="text/javascript" src="js/materialize.js"></script>
 <script type="text/javascript" src="js/addDeptScript.js"></script>
